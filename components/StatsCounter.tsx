  ...
  const defaultStats = [
    {
      ...
      value: 343,
      label: "Jeunes aidés depuis 2019"
    },
    {
      icon: (props: React.SVGProps<SVGSVGElement>) => (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" {...props}>
      ...
      value: 5,
      label: "Centres de rétablissement à l’échelle nationale"
    },
    {
      icon: (props: React.SVGProps<SVGSVGElement>) => (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" {...props}>
      ...
      value: 86,
      suffix: "%",
      label: "Taux d’achèvement du programme"
    },
    {
      icon: (props: React.SVGProps<SVGSVGElement>) => (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" {...props}>
      ...
      suffix: "%",
      prefix: '',
      label: "Taux de réussite de sobriété sur 5 ans"
    },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="mt-4 text-xl text-gray-600 max-w-3xl mx-auto">
            Depuis plus de 5 ans, nous nous engageons à aider les jeunes à se libérer de l’addiction et à reprendre leur vie en main.
          </p>
        </div>
